...
export default function Home() {
  ...
  const fetchTickets = async () => {
    showLoader();
    try {
      const res = await fetch(`${API_BASE}/tickets?available=true&page=1&limit=3`);
  ...
  return (
    <div className="min-h-screen">
      <Helmet>
        ...
        <meta name="description" content="Exchange or find confirmed train tickets and save cancellation charges at MyYatraExchange." />
      </Helmet>
      ...
      <div className="relative h-[60vh] sm:h-[70vh] md:h-[80vh] w-full overflow-hidden">
        ...
        <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center items-center text-white text-center px-4">
          ...
          <p className="text-lg md:text-xl mb-6 max-w-xl">
            Share your unused train ticket and help others get confirmed tickets instantly.
          </p>
