  ...
  return (
    <div className="container mx-auto px-4 py-10">
      ...
      <ul className="list-disc list-inside mb-4">
        ...
        <li>
          ROHIT AKODIYA does not accept cancellation requests for perishable items like flowers, eatables, etc. However, the refund / replacement can be made if the user establishes that the quality of the product delivered is not good.
        </li>
        <li>
        ...
        <li>
          In case of any refunds approved by ROHIT AKODIYA, it will take 2 days for the refund to be processed to you.
        </li>
      </ul>
    </div>
  );
