...
export default function FindTicket() {
  ...
  return (
    <div className="p-6 container mx-auto flex flex-col items-center">
      ...
      {/* Ticket List */}
      <div className="grid gap-6 w-full max-w-4xl sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
        {filtered.map((t) => (
          <div
            key={t._id}
            className="rounded-xl shadow-lg p-6 bg-white border border-gray-200 hover:shadow-2xl transition duration-300 text-sm flex flex-col justify-start gap-2.5"
          >
