  ...
  return (
    <div className="max-w-3xl mx-auto p-6 bg-white shadow-lg rounded-lg">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <button
          type="submit"
          className="w-full bg-blue-600 text-white px-6 py-2 rounded font-semibold hover:bg-blue-700"
        >
          Post Ticket
        </button>
      </form>
